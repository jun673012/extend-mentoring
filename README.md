...
# 스터디 방법
<<<<<<< HEAD
8주간의 스터디입니다. 매주 문제를 선정하여 업데이트할 테니 해당 문제를 보시고 해결하시면 돼요!<br>
각 주차의 폴더에 problem 파일과 각자의 이니셜 폴더가 있을 거예요. problem 파일을 보셔서 매주 업데이트된 문제를 확인하시고, 각자의 폴더에 여러분이 해결하신 코드를 올려주시면 됩니다!<br>
매주 화요일 22시 온라인으로 여러분들이 올려주신 코드를 통해 어떻게 해결하셨는지 소개하는 시간을 가지도록 할게요!<br>
해결하시다가 어렵다 or 모르는 부분이 있었다 라는 문제를 각자 3문제 선정해서 어떻게 해결하였는지 소개 후 토론하는 방식으로 진행할게요.<br>
만약 없으셨다면 제가 문제를 선정해서 그 문제에 대해 토론할게요.<br>
=======
...
>>>>>>> 1abd260a7aad096caefa165ac159a69f445f44d3
